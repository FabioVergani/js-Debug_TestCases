...
function kindOf(x){
	var s=strObj(x).slice(8,-1).toLowerCase(),o=function(v){return{configurable:false,writable:false,value:v}},p=Rgx.Pattern.PrimitiveTypes;
	return rawObj({type:o(s),isPrimitive:o(x==null||p.test(s))});
};
